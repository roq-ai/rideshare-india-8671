...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['App Administrator'];
  const customerRoles: string[] = ['Passenger'];
  const tenantRoles: string[] = ['App Administrator', 'Customer Support', 'Marketing Manager'];
  const addOns: string[] = ['chat', 'notifications'];
  const applicationName = `RideShare India`;
